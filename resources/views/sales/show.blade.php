    ...
    <div class="py-12 bg-gray-50 min-h-screen font-sans">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded shadow-sm flex justify-between items-center">
                ...
                <a href="{{ route('sales.create') }}" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg text-xs shadow">
                    + Nueva Venta
                </a>
            </div>
            @endif
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 p-8">
                ...
                <div class="flex justify-between items-start border-b border-gray-100 pb-6 mb-6">
                    <div>
                        <h1 class="text-3xl font-extrabold text-gray-800">{{ $sale->client->name }}</h1>
                        ...
                        <div class="mt-2">
                            ...
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-lg text-xs font-bold {{ $sale->tipo_venta == 'Credito' ? 'bg-orange-50 text-orange-700' : 'bg-green-50 text-green-700' }} border ml-2">
                                {{ $sale->tipo_venta }}
                            </span>
                        </div>
                    </div>
                    <div class="text-right">
                        ...
                        <p class="text-4xl font-extrabold text-gray-900">${{ number_format($sale->total, 2) }}</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    ...
                    <div class="border border-gray-200 rounded-xl p-4 flex justify-between items-center bg-gray-50 hover:bg-white hover:shadow-md transition">
                        <div>
                            ...
                            <p class="text-lg font-mono font-bold text-gray-800">{{ $vale->folio_vale }}</p>
                ...
                <div class="bg-gray-50 rounded-xl p-6 border border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex gap-3">
                        <a href="{{ route('sales.ticket', $sale->id) }}" target="_blank" 
                           class="flex items-center gap-2 bg-gray-800 hover:bg-gray-900 text-white font-bold py-3 px-6 rounded-xl shadow-lg transition transform hover:scale-105">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path></svg>
                            Imprimir Tickets (80mm)
                        </a>
                        <a href="{{ route('sales.email', $sale->id) }}" class="inline-flex items-center px-4 py-2 bg-purple-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-purple-700 active:bg-purple-900 focus:outline-none focus:border-purple-900 focus:ring ring-purple-300 disabled:opacity-25 transition ease-in-out duration-150 ml-2">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                            Enviar por Correo
                        </a>
                        <a href="{{ route('sales.pdf', $sale->id) }}" target="_blank" 
                           class="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-6 rounded-xl shadow-lg transition transform hover:scale-105">
