    ...
    <div class="min-h-screen w-full flex">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 bg-white relative">
            ...
            <div class="absolute top-10 right-10">
                <h2 class="align-items text-xl font-bold text-gray-800">Vales Agregados</h2>
            </div>
            ...
            <div class="w-full max-w-md mt-10">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-500 text-sm">Inicia sesión para acceder a tu cuenta.</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div x-data="{ show: false }">
                        ...
                        <div class="relative">
                            ...
                            <input id="password" :type="show ? 'text' : 'password'" name="password" required
                                class="w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all placeholder-gray-400"
                    ...
                    <button type="submit" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-md text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                        Acceder
                    </button>
                </form>

                <div class="mt-12 text-center text-sm text-gray-400">
                    &copy; {{ date('Y') }} AgregadosSys
                </div>
            </div>
        </div>
    </div>
